        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-300 hover:text-white transition-colors duration-200">Accueil</Link>
              </li>
              <li>
                <Link to="/cadastre" className="text-gray-300 hover:text-white transition-colors duration-200">Cadastre</Link>
              </li>
              <li>
                <Link to="/topographie" className="text-gray-300 hover:text-white transition-colors duration-200">Topographie</Link>
              </li>
            </ul>
          </div>
